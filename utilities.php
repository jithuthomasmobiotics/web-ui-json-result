<?php
function getResponseResult($id=null,$params){

    $initialarray = array(
            array("Id"=>1,"Name"=>"Barbarian","Level"=>4,"Description"=>"The Barbarian is a kilt-clad Scottish warrior with an angry, battle-ready expression, hungry for destruction. He has Killer yellow horseshoe mustache."),
            array("Id"=>2,"Name"=>"The Archer","Level"=>5,"Description"=>"The Archer is a female warrior with sharp eyes. She wears a short, light green dress, a hooded cape, a leather belt and an attached small pouch."),
            array("Id"=>3,"Name"=>"The Giant","Level"=>5,"Description"=>"Slow, steady and powerful, Giants are massive warriors that soak up huge amounts of damage. Show them a turret or cannon and you'll see their fury unleashed!"),
            array("Id"=>4,"Name"=>"The Goblin","Level"=>5,"Description"=>"These pesky little creatures only have eyes for one thing: LOOT! They are faster than a Spring Trap, and their hunger for resources is limitless."),
            array("Id"=>5,"Name"=>"The Wizard","Level"=>6,"Description"=>"The Wizard is a terrifying presence on the battlefield. Pair him up with some of his fellows and cast concentrated blasts of destruction on anything, land or sky!")
                );
    ...
    if(!empty($id)){
        ...
        if (!is_numeric($id))
        {
            ...
            if($id > $maxcount){
                return array('error'=>1001,'reason'=>'Invalid Index');
            }else{
                $key = ($id - 1);
